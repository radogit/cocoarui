...
const combinedPresets = [
    ...
    { id: "layout-descent", label: "Descent (PPD+VR2) (prepped)", panelId: "spawnButtonContainerDynamicGroups", uiButtonColour: "#a0a0a0", nodeColour: "#808080", 
      entries: [
        { sourceId: "Layouts", entryName: "PPD-speed",      nodeLabel: "1-speed",      nodeCircleOpacity: 0.60, nodeColour: "#00f"},
        { sourceId: "Layouts", entryName: "PPD-distance",   nodeLabel: "2-distance",   nodeCircleOpacity: 0.55, nodeColour: "#00f"},
        { sourceId: "Layouts", entryName: "PPD-navigation", nodeLabel: "3-navigation", nodeCircleOpacity: 0.50, nodeColour: "#00f"},
        { sourceId: "Layouts", entryName: "PPD-speed2",     nodeLabel: "4-speed2",     nodeCircleOpacity: 0.45, nodeColour: "#00f"},
        { sourceId: "Layouts", entryName: "PPD-time",       nodeLabel: "5-time",       nodeCircleOpacity: 0.40, nodeColour: "#00f"},
        { sourceId: "Layouts", entryName: "PPD-power",      nodeLabel: "6-power",      nodeCircleOpacity: 0.35, nodeColour: "#00f"},
        { sourceId: "Layouts", entryName: "PPD-distance2",  nodeLabel: "7-distance2",  nodeCircleOpacity: 0.30, nodeColour: "#00f"},
        { sourceId: "Layouts", entryName: "PPD-heartrate",  nodeLabel: "8-heartrate",  nodeCircleOpacity: 0.25, nodeColour: "#00f"},
