...
const combinedPresets = [
    ...
    { id: "layout-PPD", label: "Layout (Paper Pano Descent)", panelId: "spawnButtonContainerDynamicGroups", uiButtonColour: "#66f", nodeColour: "#00f", 
      entries: [
        { sourceId: "PPD", entryName: "Speed-PP-descent",      nodeLabel: "speed",      nodeCircleOpacity: 0.60 },
        { sourceId: "PPD", entryName: "Distance-PP-descent",   nodeLabel: "distance",   nodeCircleOpacity: 0.55 },
        { sourceId: "PPD", entryName: "Navigation-PP-descent", nodeLabel: "navigation", nodeCircleOpacity: 0.50 },
        { sourceId: "PPD", entryName: "Speed-PP-descent",      nodeLabel: "speed",      nodeCircleOpacity: 0.45 },
        { sourceId: "PPD", entryName: "Time-PP-descent",       nodeLabel: "time",       nodeCircleOpacity: 0.40 },
        { sourceId: "PPD", entryName: "Power-PP-descent",      nodeLabel: "power",      nodeCircleOpacity: 0.35 },
        { sourceId: "PPD", entryName: "Distance-PP-descent",   nodeLabel: "distance",   nodeCircleOpacity: 0.30 },
        { sourceId: "PPD", entryName: "Heartrate-PP-descent",  nodeLabel: "heartrate",  nodeCircleOpacity: 0.25 },
      ] 
    },
    { id: "layout-PPA", label: "Layout (Paper Pano Ascent)", panelId: "spawnButtonContainerDynamicGroups", uiButtonColour: "#ff0000", nodeColour: "#f00", 
      entries: [
        { sourceId: "PPA", entryName: "Speed-PP-ascent",      nodeLabel: "speed",      nodeCircleOpacity: 0.60 },
        { sourceId: "PPA", entryName: "Distance-PP-ascent",   nodeLabel: "distance",   nodeCircleOpacity: 0.55 },
        { sourceId: "PPA", entryName: "Navigation-PP-ascent", nodeLabel: "navigation", nodeCircleOpacity: 0.50 },
        { sourceId: "PPA", entryName: "Power-PP-ascent",      nodeLabel: "power",      nodeCircleOpacity: 0.45 },
        { sourceId: "PPA", entryName: "Time-PP-ascent",       nodeLabel: "time",       nodeCircleOpacity: 0.40 },
        { sourceId: "PPA", entryName: "Gradient-PP-ascent",   nodeLabel: "gradient",   nodeCircleOpacity: 0.35 },
        { sourceId: "PPA", entryName: "Heartrate-PP-ascent",  nodeLabel: "heartrate",  nodeCircleOpacity: 0.30 },
        { sourceId: "PPA", entryName: "Speed-PP-ascent",      nodeLabel: "speed",      nodeCircleOpacity: 0.25 },
        { sourceId: "PPA", entryName: "Distance-PP-ascent",   nodeLabel: "distance",   nodeCircleOpacity: 0.20 },
        { sourceId: "PPA", entryName: "Navigation-PP-ascent", nodeLabel: "navigation", nodeCircleOpacity: 0.15 },
      ] 
    },
    { id: "layout-VR1", label: "Layout (VR1)", panelId: "spawnButtonContainerDynamicGroups", uiButtonColour: "#ff8000", nodeColour: "#ff8000", nodeFill: "url(#diag-hatch-orange)",
      entries: [
        { sourceId: "VR1", entryName: "type-speed",      nodeLabel: "speed",      nodeCircleOpacity: 0.60 },
        { sourceId: "VR1", entryName: "type-navigation", nodeLabel: "navigation", nodeCircleOpacity: 0.55 },
        { sourceId: "VR1", entryName: "type-distance",   nodeLabel: "distance",   nodeCircleOpacity: 0.50 },
        { sourceId: "VR1", entryName: "type-heartrate",  nodeLabel: "heartrate",  nodeCircleOpacity: 0.45 },
        { sourceId: "VR1", entryName: "type-power",      nodeLabel: "power",      nodeCircleOpacity: 0.40 },
        { sourceId: "VR1", entryName: "type-speed",      nodeLabel: "speed",      nodeCircleOpacity: 0.35 },
        { sourceId: "VR1", entryName: "type-gradient",   nodeLabel: "gradient",   nodeCircleOpacity: 0.30 },
        { sourceId: "VR1", entryName: "type-navigation", nodeLabel: "navigation", nodeCircleOpacity: 0.25 },
      ] 
    },
    { id: "layout-VR2", label: "Layout (VR2)", panelId: "spawnButtonContainerDynamicGroups", uiButtonColour: "#ff8000", nodeColour: "#ff8000", 
      entries: [
        { sourceId: "VR2", entryName: "type-speed",       nodeLabel: "speed",      nodeCircleOpacity: 0.60 },
        { sourceId: "VR2", entryName: "type-navigation",  nodeLabel: "navigation", nodeCircleOpacity: 0.55 },
        { sourceId: "VR2", entryName: "type-distance",    nodeLabel: "distance",   nodeCircleOpacity: 0.50 },
        { sourceId: "VR2", entryName: "type-power",       nodeLabel: "power",      nodeCircleOpacity: 0.45 },
        { sourceId: "VR2", entryName: "type-heartrate",   nodeLabel: "heartrate",  nodeCircleOpacity: 0.40 },
        { sourceId: "VR2", entryName: "type-speed",       nodeLabel: "speed",      nodeCircleOpacity: 0.35 },
        { sourceId: "VR2", entryName: "type-gradient",    nodeLabel: "gradient",   nodeCircleOpacity: 0.30 },
        { sourceId: "VR2", entryName: "type-navigation",  nodeLabel: "navigation", nodeCircleOpacity: 0.25 },
        { sourceId: "VR2", entryName: "type-time",        nodeLabel: "time",       nodeCircleOpacity: 0.20 },
      ] 
    },
    { id: "layout-VR3", label: "Layout (VR3)", panelId: "spawnButtonContainerDynamicGroups", uiButtonColour: "#900090", nodeColour: "#900090", nodeFill: "url(#diag-hatch-purple)",
      entries: [
        { sourceId: "VR3", entryName: "type-speed",      nodeLabel: "speed",      nodeCircleOpacity: 0.60 },
        { sourceId: "VR3", entryName: "type-power",      nodeLabel: "power",      nodeCircleOpacity: 0.55 },
        { sourceId: "VR3", entryName: "type-distance",   nodeLabel: "distance",   nodeCircleOpacity: 0.50 },
        { sourceId: "VR3", entryName: "type-navigation", nodeLabel: "navigation", nodeCircleOpacity: 0.45 },
        { sourceId: "VR3", entryName: "type-heartrate",  nodeLabel: "heartrate",  nodeCircleOpacity: 0.40 },
        { sourceId: "VR3", entryName: "type-gradient",   nodeLabel: "gradient",   nodeCircleOpacity: 0.35 },
        { sourceId: "VR3", entryName: "type-speed",      nodeLabel: "speed",      nodeCircleOpacity: 0.30 },
        { sourceId: "VR3", entryName: "type-power",      nodeLabel: "power",      nodeCircleOpacity: 0.25 },
        { sourceId: "VR3", entryName: "type-time",       nodeLabel: "time",       nodeCircleOpacity: 0.20 },
      ] 
    },
    { id: "layout-VR4", label: "Layout (VR4)", panelId: "spawnButtonContainerDynamicGroups", uiButtonColour: "#900090", nodeColour: "#900090", 
      entries: [
        { sourceId: "VR4", entryName: "type-speed",      nodeLabel: "speed",      nodeCircleOpacity: 0.60 },
        { sourceId: "VR4", entryName: "type-power",      nodeLabel: "power",      nodeCircleOpacity: 0.55 },
        { sourceId: "VR4", entryName: "type-distance",   nodeLabel: "distance",   nodeCircleOpacity: 0.50 },
        ...
        { sourceId: "VR4", entryName: "type-speed",      nodeLabel: "speed",      nodeCircleOpacity: 0.30 },
        { sourceId: "VR4", entryName: "type-power",      nodeLabel: "power",      nodeCircleOpacity: 0.25 },
        { sourceId: "VR4", entryName: "type-time",       nodeLabel: "time",       nodeCircleOpacity: 0.20 },
      ] 
    },
    { id: "layout-descent", label: "Descent (PPD+VR2) (prepped)", panelId: "spawnButtonContainerDynamicGroups", uiButtonColour: "#a0a0a0", nodeColour: "#808080", 
      entries: [
        { sourceId: "Layouts", entryName: "PPD-speed",      nodeLabel: "PPD-speed",      nodeCircleOpacity: 0.60, nodeColour: "#00f"},
        { sourceId: "Layouts", entryName: "PPD-distance",   nodeLabel: "PPD-distance",   nodeCircleOpacity: 0.55, nodeColour: "#00f"},
        { sourceId: "Layouts", entryName: "PPD-navigation", nodeLabel: "PPD-navigation", nodeCircleOpacity: 0.50, nodeColour: "#00f"},
        { sourceId: "Layouts", entryName: "PPD-speed2",     nodeLabel: "PPD-speed2",     nodeCircleOpacity: 0.45, nodeColour: "#00f"},
        { sourceId: "Layouts", entryName: "PPD-time",       nodeLabel: "PPD-time",       nodeCircleOpacity: 0.40, nodeColour: "#00f"},
        { sourceId: "Layouts", entryName: "PPD-power",      nodeLabel: "PPD-power",      nodeCircleOpacity: 0.35, nodeColour: "#00f"},
        { sourceId: "Layouts", entryName: "PPD-distance2",  nodeLabel: "PPD-distance2",  nodeCircleOpacity: 0.30, nodeColour: "#00f"},
        { sourceId: "Layouts", entryName: "PPD-heartrate",  nodeLabel: "PPD-heartrate",  nodeCircleOpacity: 0.25, nodeColour: "#00f"},


        { sourceId: "Layouts", entryName: "VR2-speed",       nodeLabel: "VR2-speed",         nodeCircleOpacity: 0.60, nodeColour: "#ff8000"},
        { sourceId: "Layouts", entryName: "VR2-navigation",  nodeLabel: "VR2-navigation",    nodeCircleOpacity: 0.55, nodeColour: "#ff8000" },
        { sourceId: "Layouts", entryName: "VR2-distance",    nodeLabel: "VR2-distance",      nodeCircleOpacity: 0.50, nodeColour: "#ff8000" },
        { sourceId: "Layouts", entryName: "VR2-power",       nodeLabel: "VR2-power",         nodeCircleOpacity: 0.45, nodeColour: "#ff8000" },
        { sourceId: "Layouts", entryName: "VR2-heartrate",   nodeLabel: "VR2-heartrate",     nodeCircleOpacity: 0.40, nodeColour: "#ff8000" },
        { sourceId: "Layouts", entryName: "VR2-speed2",      nodeLabel: "VR2-speed #2",      nodeCircleOpacity: 0.35, nodeColour: "#ff8000" },
        { sourceId: "Layouts", entryName: "VR2-gradient",    nodeLabel: "VR2-gradient",      nodeCircleOpacity: 0.30, nodeColour: "#ff8000" },
        { sourceId: "Layouts", entryName: "VR2-navigation2", nodeLabel: "VR2-navigation #2", nodeCircleOpacity: 0.25, nodeColour: "#ff8000" },
        { sourceId: "Layouts", entryName: "VR2-time",        nodeLabel: "VR2-time",          nodeCircleOpacity: 0.20, nodeColour: "#ff8000" },
      ]
    },
    { id: "layout-ascent", label: "Ascent (PPA+VR4) (prepped)", panelId: "spawnButtonContainerDynamicGroups", uiButtonColour: "#a0a0a0", nodeColour: "#808080", 
      entries: [
        { sourceId: "Layouts", entryName: "PPA-speed",      nodeLabel: "PPA-speed",         nodeCircleOpacity: 0.60, nodeColour: "#f00" },
        { sourceId: "Layouts", entryName: "PPA-distance",   nodeLabel: "PPA-distance",      nodeCircleOpacity: 0.55, nodeColour: "#f00" },
        { sourceId: "Layouts", entryName: "PPA-navigation", nodeLabel: "PPA-navigation",    nodeCircleOpacity: 0.50, nodeColour: "#f00" },
        { sourceId: "Layouts", entryName: "PPA-power",      nodeLabel: "PPA-power",         nodeCircleOpacity: 0.45, nodeColour: "#f00" },
        { sourceId: "Layouts", entryName: "PPA-time",       nodeLabel: "PPA-time",          nodeCircleOpacity: 0.40, nodeColour: "#f00" },
        { sourceId: "Layouts", entryName: "PPA-gradient",   nodeLabel: "PPA-gradient",      nodeCircleOpacity: 0.35, nodeColour: "#f00" },
        { sourceId: "Layouts", entryName: "PPA-heartrate",  nodeLabel: "PPA-heartrate",     nodeCircleOpacity: 0.30, nodeColour: "#f00" },
        { sourceId: "Layouts", entryName: "PPA-speed2",     nodeLabel: "PPA-speed #2",      nodeCircleOpacity: 0.25, nodeColour: "#f00" },
        { sourceId: "Layouts", entryName: "PPA-distance2",  nodeLabel: "PPA-distance #2",   nodeCircleOpacity: 0.20, nodeColour: "#f00" },
        { sourceId: "Layouts", entryName: "PPA-navigation2",nodeLabel: "PPA-navigation #2", nodeCircleOpacity: 0.15, nodeColour: "#f00" },

        { sourceId: "Layouts", entryName: "VR4-speed",      nodeLabel: "VR4-speed",      nodeCircleOpacity: 0.60, nodeColour: "#900090" },
        { sourceId: "Layouts", entryName: "VR4-power",      nodeLabel: "VR4-power",      nodeCircleOpacity: 0.55, nodeColour: "#900090" },
        { sourceId: "Layouts", entryName: "VR4-distance",   nodeLabel: "VR4-distance",   nodeCircleOpacity: 0.50, nodeColour: "#900090" },
        { sourceId: "Layouts", entryName: "VR4-navigation", nodeLabel: "VR4-navigation", nodeCircleOpacity: 0.45, nodeColour: "#900090" },
        { sourceId: "Layouts", entryName: "VR4-heartrate",  nodeLabel: "VR4-heartrate",  nodeCircleOpacity: 0.40, nodeColour: "#900090" },
        { sourceId: "Layouts", entryName: "VR4-gradient",   nodeLabel: "VR4-gradient",   nodeCircleOpacity: 0.35, nodeColour: "#900090" },
        { sourceId: "Layouts", entryName: "VR4-speed2",     nodeLabel: "VR4-speed #2",   nodeCircleOpacity: 0.30, nodeColour: "#900090" },
        { sourceId: "Layouts", entryName: "VR4-power2",     nodeLabel: "VR4-power #2",   nodeCircleOpacity: 0.25, nodeColour: "#900090" },
        { sourceId: "Layouts", entryName: "VR4-time",       nodeLabel: "VR4-time",       nodeCircleOpacity: 0.20, nodeColour: "#900090" },
